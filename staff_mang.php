                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%"
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Change Shift</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='index.php?emp_history&empid=<?php echo $staff['emp_id']; ?>'
                                           class="btn btn-success" title="Employee History" style="border-radius:60px;"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <select style="visibility: hidden;" class="form-control" id="shift" name="shift_id" required>
                                                        <option selected disabled>Select Shift Time</option>
                                                        <?php
